...
class InfoLogger
{
    ...
    public function __construct(string $pagename)
    {
        ...
        $this->logger->info('Посетитель с IP ' . $ip . ' зашёл на страничку ♂perfomance artist♂, известного как ♂' . $this->nameofperfomanceartist . '♂, в дату ' . date('d.m.Y г. во время H:i:s') . " по Владивостоку.");
